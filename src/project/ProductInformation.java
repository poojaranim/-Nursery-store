...
public class ProductInformation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        productInfoidName = new javax.swing.JLabel();
        productInfoname = new javax.swing.JLabel();
        ...
        productInfoid.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        productInfoid.setText("Id:");
        ...
        productInfoidName.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        productInfoidName.setForeground(new java.awt.Color(0, 77, 64));
        productInfoidName.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        productInfoname.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        productInfoname.setForeground(new java.awt.Color(0, 77, 64));
        productInfoname.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        productInfoPrice.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        productInfoPrice.setForeground(new java.awt.Color(0, 77, 64));
        productInfoPrice.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        productInfoStock.setFont(new java.awt.Font("Roboto", 1, 14)); // NOI18N
        productInfoStock.setForeground(new java.awt.Color(0, 77, 64));
        productInfoStock.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(productInfoBrand1, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(productInfoBrand3)
                    .addComponent(productInfoBrand2)
                    .addComponent(productInfoid))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(productInfoStock, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                    .addComponent(productInfoPrice, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(productInfoname, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(productInfoidName, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(63, 63, 63)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(88, 88, 88)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(productInfoid, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(productInfoidName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(74, 74, 74)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(productInfoBrand3)
                            .addComponent(productInfoname, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(67, 67, 67)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void addToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToCartActionPerformed
        ...
        if(Integer.parseInt(this.productInfoStock.getText())<Integer.parseInt(this.productQtyField.getText())){
            ...
            ProductList p = new ProductList(this.productInfoidName.getText(), this.productInfoname.getText(), qty*Integer.parseInt(this.productInfoPrice.getText()), 
          ...
          /*  int qtyTester = Integer.parseInt(this.productInfoStock.getText())-Integer.parseInt(this.productQtyField.getText());
            ...
            if(categoryChooser.equals("accessories"))
                    MobileDB.updateMobileDB(this.productInfoname.getText(), qtyTester);
            else if(categoryChooser.equals("kids"))
                    KidsDB.updateKidsDB(this.productInfoname.getText(), qtyTester);
            else if(categoryChooser.equals("electronics"))
                    ElectronicsDB.updateElectronicsDB(this.productInfoname.getText(), qtyTester);*/
    ...
    private javax.swing.JLabel productInfoid;
    public javax.swing.JLabel productInfoidName;
    public javax.swing.JLabel productInfoname;
